...
Security fixes target the latest stable release. Older releases do not receive
backported fixes. Please update before reproducing an issue when possible.
...
impact. The maintainer will coordinate investigation and disclosure privately.
